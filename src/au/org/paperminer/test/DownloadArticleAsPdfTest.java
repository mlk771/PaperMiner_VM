...
public class DownloadArticleAsPdfTest {
  ...
  @Test
  public void testDownloadArticleAsPdf() throws Exception {
    ...
    driver.findElement(By.linkText("1919-12-21")).click();
    driver.findElement(By.linkText("PDF Link")).click();
